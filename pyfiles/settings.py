...
"ㄱ","ㄴ","ㄷ","ㄹ","ㅁ","ㅂ","ㅅ","ㅇ","ㅈ","ㅊ","ㅋ","ㅌ","ㅍ","ㅎ","ㅏ","ㅑ","ㅣ","ㅐ","ㅔ","ㅓ","ㅕ","ㅛ","ㅗ","ㅠ","ㅜ","ㅡ","ㅖ","ㅢ","ㅟ","ㅚ","ㅙ","ㅒ",
"은",
"진다",
"가",
"가까스로",
...
# Pagination
client.index(indexes[index_num-1]).update_pagination_settings({"maxTotalHits":1000})

# Faceting
client.index(indexes[index_num-1]).update_faceting_settings({"maxValuesPerFacet":100})
